<?php
  ...
  * 1.0.8 - 2013-07-28 - BugFix: isset, empty stack, spaces in tags.
  * </pre>
  */
...
class HTMLTable { 
  ...
  function parse($dat) { 
    ...
    if( empty($tags) ) { 
      $this->error = "parse error: tag stack is empty. no table?";
      return false;
    }
  ...
  function formatTableHtml($thead=null,$tbody=null,$tfoot=null,$attrs=null) {
    ...
    return $html;
  } // END: function formatTableHtml($thead,$tbody,$tfoot,$attr
